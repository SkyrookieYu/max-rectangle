...
for i in range(height):
	...
	if(i==(height-1)):
		#Check that our current area is larger than the width
		#So we don't have to process the last line
		if(area>width):
			break
...
cv2.waitKey(0)
cv2.imwrite("image.png",real_image)

results = [xmin,(height-ymax),(height-ymin-1),(xmax-1)]